// =============================================================================
// app.js — このファイルは廃止されました
//
// JS は以下のファイルに分割されています。build.js がビルド時に結合します。
//   js/utils.js   … 共通ユーティリティ（escapeHtml など）
//   js/home.js    … ホーム画面（カレンダー・請求履歴）
//   js/upload.js  … アップロード画面（CSV読み込み・バリデーション・状態管理）
//   js/confirm.js … 確認画面（モーダル・送信処理・テーブル描画）
//   js/router.js  … SPA ルーター
// =============================================================================
